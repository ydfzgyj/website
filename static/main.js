...
var constructHook=data&&data.hook&&data.hook.construct;if(constructHook){constructHook(this);}};var emptyVNode=function(){var node=new VNode();node.text='';node.isComment=true;return node;};// optimized shallow clone
...
factory.pendingCallbacks.push(cb);}else{factory.requested=true;var cbs=factory.pendingCallbacks=[cb];var sync=true;var resolve=function(res){if(isObject(res)){res=Vue.extend(res);}// cache resolved
...
function createElement(tag,data,children){if(data&&(Array.isArray(data)||typeof data!=='object')){children=data;data=undefined;}// make sure to use real instance instead of proxy as context
...
var identity=function(_){return _;};Vue.prototype._f=function resolveFilter(id){return resolveAsset(this.$options,'filters',id,true)||identity;};// render v-for
...
if(true){slotNodes._rendered&&warn("Duplicate presense of slot \""+name+"\" found in the same render tree "+"- this will likely cause render errors.",this);slotNodes._rendered=true;}// clone slot nodes on re-renders
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_home__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hello__ = __webpack_require__(6);
...
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vuex___default.a);
...
(function (global, factory) {
  ...
  var View = {
    ...
    render: function render(h, ref) {
      ...
      var component = inactive ? cache[props.name] : cache[props.name] = matched.components[props.name];
  ...
  function isSameRoute(a, b) {
    if (!b) {
      ...
      return a.path === b.path && a.hash === b.hash && isObjectEqual(a.query, b.query);
  ...
  function fillParams(path, params, routeMsg) {
    try {
      var filler = regexpCompileCache[path] || (regexpCompileCache[path] = Regexp.compile(path));
  ...
  History.prototype.confirmTransition = function confirmTransition(route, cb) {
    ...
    extractEnterGuards(activated, postEnterCbs)).filter(function (_) {
      return _;
    });

    this.pending = route;
    var redirect = function (location) {
      return this$1.push(location);
    };

    runQueue(queue, function (hook, next) {
      hook(route, redirect, next);
    }, function () {
  ...
  function flatMapComponents(matched, fn) {
    return Array.prototype.concat.apply([], matched.map(function (m) {
      return Object.keys(m.components).map(function (key) {
        return fn(m.components[key], m.instances[key] && m.instances[key].child, m, key);
      });
    }));
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__template_html__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__style_less__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__template_html__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__template_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__template_html__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_client__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_routes__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_store__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__public_less__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__public_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__public_less__);
...
window.G = __WEBPACK_IMPORTED_MODULE_2_client__["a" /* default */];
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a.config.devtools = true;

__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_router___default.a);
const router = new __WEBPACK_IMPORTED_MODULE_1_vue_router___default.a({
	mode: 'history',
	routes: __WEBPACK_IMPORTED_MODULE_3_routes__["a" /* default */]
});
new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a({
	router,
	template: '<router-view></router-view>',
	store: __WEBPACK_IMPORTED_MODULE_4_store__["a" /* default */],
	data() {
		return {
			global: G,
			loading: true
...
// });
//全局自定义过滤器
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a.filter('dateFormat', (date, format = 'Y-m-d h:i:s') => {
	if (date === undefined) {
		return '';
	}
	date = new Date(date);
